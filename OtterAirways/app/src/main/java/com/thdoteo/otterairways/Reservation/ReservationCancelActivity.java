...
public class ReservationCancelActivity extends AppCompatActivity {
    ...
    private class ReservationAdapter extends RecyclerView.Adapter<ItemHolder> {
        ...
        public void onBindViewHolder(ItemHolder holder, final int position) {
            ...
            Flight flight = AppRoom.getDatabase(ReservationCancelActivity.this).dao().getFlight(reservation.getFlight_id());
            String text = "Reservation " + reservation.getId() + " : " + flight.getNumber() + " - " + flight.getDeparture() + " -> " + flight.getArrival() + " at " + flight.getDeparture_at() + " (" + reservation.getSeats() + " seats)";
